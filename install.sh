#!/usr/bin/env sh
# Universal installer for claimtrace. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/claimtrace.git"
echo "Installing claimtrace ..."
